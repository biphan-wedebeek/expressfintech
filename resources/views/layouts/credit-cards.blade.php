                    ...
                    <div class="bg-white rounded-2xl border border-[#e8e2f8] overflow-hidden"
                        ...
                        <div class="pt-4 pb-2">
                            ...
                            <nav class="px-2">
                                <a href="{{ route('cards.mechanics-scoring') }}"
                                    ...
                                    <svg class="w-3.5 h-3.5 text-[#c4b5fd] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        ...
                        <div class="pt-3 pb-3">
                            ...
                            <nav class="px-2">
                                ...
                                <a href="{{ route('cards.market-experian_fico') }}"
                                    class="sidebar-link flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-[13px] font-medium text-[#374151] @yield('nav_experian')">
                                    <svg class="w-3.5 h-3.5 text-[#c4b5fd] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 17l6-6 4 4 8-8" />
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M21 21H3V3" />
                                    </svg>
                                    Free FICO® Score
                                </a>
                            </nav>
