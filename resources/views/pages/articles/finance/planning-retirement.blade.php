        ...
        <div class="grid lg:grid-cols-2 gap-12 items-start">
            <div>
                ...
                <ul class="space-y-3 text-sm text-muted">
                    ...
                    <li class="flex gap-3">
                        <span class="text-emerald-600 font-bold">→</span>
                        <span><strong>401(k) limit {{ now()->year }}</strong>: $23,000</span>
                    </li>

                    <li class="flex gap-3">
                        <span class="text-emerald-600 font-bold">→</span>
                        <span><strong>Roth IRA limit {{ now()->year }}</strong>: $7,000</span>
                    </li>

                    <li class="flex gap-3">
                        <span class="text-emerald-600 font-bold">→</span>
                        <span><strong>HSA limit {{ now()->year }}</strong>: $4,150</span>
                    </li>
