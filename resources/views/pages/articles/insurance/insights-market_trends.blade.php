...
@section('title','Insurance Market Trends'. now()->year)
@section('cover_kicker','Market Insights · Trends & Analysis')
@section('cover_h1_line1','Market')
@section('cover_h1_em','Trends'. now()->year)
@section('cover_deck','The forces reshaping global insurance in ' . now()->year .' — hardening markets, climate volatility, digital distribution, and the capital flows transforming competitive dynamics.')
@section('cover_date', now()->format('F Y')) 
@section('cover_read','14 min') @section('cover_topic','Market Intelligence')
...
<div class="p-item">
    ...
    <div class="p-body">
        ...
        <h2 class="p-title">The Hard Market: <em>Moderation in {{ now()->year }}</em></h2>
        <p class="p-text">The sustained hard market of 2020–2025 — driven by COVID losses, catastrophe severity, social inflation, and rising reinsurance costs — is entering a moderation phase in {{ now()->year }}. Rates continue rising across most commercial lines but at a decelerating pace, as new capacity enters the market attracted by improved returns.</p>
        <p class="p-text">Property catastrophe remains the most technically stressed line: 2025 hurricane and wildfire losses of $420B ensured reinsurers maintained discipline at January {{ now()->year }} renewals. Rate increases in cat-exposed property averaged 12–18% — down from 25–40% in 2023 peaks, but still well above long-run averages.</p>
        <div class="p-note">
            <div class="p-note-label">January {{ now()->year }} Renewal Summary</div>
...
@endsection
@section('process_title','Market Cycle Phase Analysis') 
@section('process_subtitle',now()->year .'Position')
@section('process')
