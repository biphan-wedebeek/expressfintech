...
@section('title','Reinsurance Structures')
@section('cover_kicker','Insurance Categories · Reinsurance')
...
<div class="bg-[var(--navy)] py-[14px] px-[18px]"><div class="font-['Cormorant_Garamond'] text-2xl font-bold text-[var(--white)] leading-none">1.25x</div><div class="text-[9.5px] text-white/35 uppercase tracking-[0.1em] mt-[3px]">Avg Risk-Adj Rate Increase</div></div>
<div class="bg-[var(--navy)] py-[14px] px-[18px]"><div class="font-['Cormorant_Garamond'] text-2xl font-bold text-[var(--white)] leading-none">50%</div><div class="text-[9.5px] text-white/35 uppercase tracking-[0.1em] mt-[3px]">Cat Losses Retained by Cedents</div></div>
<div class="bg-[var(--navy)] py-[14px] px-[18px]"><div class="font-['Cormorant_Garamond'] text-2xl font-bold text-[var(--white)] leading-none">$600B</div><div class="text-[9.5px] text-white/35 uppercase tracking-[0.1em] mt-[3px]">Global Reinsurance Capital</div></div>
@endsection
@section('block_label','Reinsurance Structures — Core Analysis')
@section('content')
<div class="p-item">
...
<div class="mitem"><div class="mitem-v">$340B</div><div class="mitem-l">Global Reinsurance Premiums</div></div>
<div class="mitem"><div class="mitem-v">1.25x</div><div class="mitem-l">Avg Risk-Adj Rate Increase</div></div>
<div class="mitem"><div class="mitem-v">50%</div><div class="mitem-l">Cat Losses Retained by Cedents</div></div>
<div class="mitem"><div class="mitem-v">$600B</div><div class="mitem-l">Global Reinsurance Capital</div></div>
@endsection
@section('related')
