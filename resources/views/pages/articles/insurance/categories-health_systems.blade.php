...
<div class="bg-[var(--navy)] py-[14px] px-[18px]"><div class="font-['Cormorant_Garamond'] text-2xl font-bold text-[var(--white)] leading-none">$13,590</div><div class="text-[9.5px] text-white/35 uppercase tracking-[0.1em] mt-[3px]">OOP Maximum {{ now()->year }}</div></div>
@endsection
...
<div class="mitem"><div class="mitem-v">$13,590</div><div class="mitem-l">OOP Maximum {{ now()->year }}</div></div>
@endsection
@section('related')
...
<div class="rcard"><img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&q=70" alt="Market"><div class="rcard-body"><div class="rcard-cat">Market Insights</div><div class="rcard-title">Market Trends {{ now()->year }}</div><p>Broader insurance market dynamics and their implications for Health lines.</p></div></div>
@endsection