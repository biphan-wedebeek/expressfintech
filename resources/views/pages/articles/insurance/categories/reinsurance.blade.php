...
<span class="text-[rgba(230,230,230,.85)] text-[11px] px-3 py-1.5 rounded-lg border border-[rgba(255,255,255,.15)]" style="background:rgba(255,255,255,.1)">ILS / Cat Bonds</span>
<span class="text-[rgba(230,230,230,.85)] text-[11px] px-3 py-1.5 rounded-lg border border-[rgba(255,255,255,.15)]" style="background:rgba(255,255,255,.1)">Capital Markets</span>
@endsection
...
<section class="bg-surface">
    <div class="flex items-center flex-col lg:flex-row max-w-screen-xl mx-auto py-12">
        <div class="flex-1">
            <p class="text-[11px] font-black uppercase tracking-[.16em] text-[#4f46e5] mb-5">Treaty Architecture</p>
            <h2 class="font-bold leading-snug mb-5 familyfont" style="font-size:clamp(24px,2.8vw,34px)">
...
<section class="bg-white py-12 border-y border-[#f0f1f5]">
    <p class="text-[11px] font-black uppercase tracking-[.16em] text-[#4f46e5] mb-10 text-center">Global Reinsurance — Key Metrics 2025</p>
...
<section class="max-w-screen-xl mx-auto py-12">
    <div class="rounded-2xl border border-[#e5e7eb] overflow-hidden">
        <div class="bg-[#f4f5f7] border-b border-[#e5e7eb] px-6 py-3.5">
            <span class="text-[11px] font-bold uppercase tracking-[.12em] text-[#4f46e5]">Top Global Reinsurers by Net Premium Written — 2025</span>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-[13.5px]">
                <thead class="bg-[#f4f5f7] border-b border-[#e5e7eb]">
                    <tr>
                        <th class="text-left px-6 py-3 text-[11px] font-bold uppercase tracking-wider text-[#6b7280]">#</th>
                        <th class="text-left px-6 py-3 text-[11px] font-bold uppercase tracking-wider text-[#6b7280]">Reinsurer</th>
                        <th class="text-left px-6 py-3 text-[11px] font-bold uppercase tracking-wider text-[#6b7280]">Domicile</th>
                        <th class="text-right px-6 py-3 text-[11px] font-bold uppercase tracking-wider text-[#6b7280]">NPW (USD bn)</th>
                        <th class="text-right px-6 py-3 text-[11px] font-bold uppercase tracking-wider text-[#6b7280]">Combined Ratio</th>
                        <th class="text-right px-6 py-3 text-[11px] font-bold uppercase tracking-wider text-[#6b7280]">Rating</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-[#f3f4f6]">
                    ...
                    <tr class="bg-[#ffffff] hover:bg-[#f0f1f5] transition-colors">
                        <td class="px-6 py-4 text-[#6b7280]">{{ $r[0] }}</td>
                        <td class="px-6 py-4 font-semibold text-[#1a1a1a]">{{ $r[1] }}</td>
                        <td class="px-6 py-4 text-[#6b7280]">{{ $r[2] }}</td>
                        <td class="px-6 py-4 text-right text-[#4f46e5] font-bold">${{ $r[3] }}</td>
                        <td class="px-6 py-4 text-right {{ (float)$r[4]>93?'text-amber-400':'text-green-400' }} font-semibold">{{ $r[4] }}</td>
                        <td class="px-6 py-4 text-right font-semibold text-[#6b7280]">{{ $r[5] }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
...
<section class="bg-surface">
    <div class="flex items-center flex-col lg:flex-row-reverse max-w-screen-xl mx-auto py-12 gap-10">
        <div class="flex-1">
            <p class="text-[11px] font-black uppercase tracking-[.16em] text-[#4f46e5] mb-5">ILS & Cat Bonds</p>
