...
<span class="text-[#e6e6e6d9] text-[11px] px-3 py-1.5 rounded-lg border border-[#ffffff26] bg-[#ffffff1a]">Telematics</span>
<span class="text-[#e6e6e6d9] text-[11px] px-3 py-1.5 rounded-lg border border-[#ffffff26] bg-[#ffffff1a]">EV Transition</span>
@endsection
...
<section class="bg-[#0e1118]">
    <div class="flex items-center gap-0 flex-col lg:flex-row max-w-screen-xl mx-auto">
        <div class="flex-1 py-12 lg:py-16 pr-8">
            <p class="text-[11px] font-black uppercase tracking-[.16em] text-[#c9a96e] mb-5">Telematics & UBI</p>
...
<section class="py-12">
    <p class="text-[11px] font-black uppercase tracking-[0.16em] text-[#c9a96e] mb-10 text-center">Auto Insurance — Key Market Metrics 2025</p>
...
<section class="py-12 max-w-screen-xl mx-auto">
    <div class="bg-white border border-[#e8e0d8] rounded-2xl p-6 hover:border-[#c9a96e] hover:shadow-lg transition-all duration-300 group overflow-hidden">
        <div class="pb-2.5">
            <span class="text-[11px] font-bold uppercase tracking-[.12em] text-[#c9a96e]">Telematics Program Comparison — Major U.S. Carriers</span>
        </div>
        <div class="overflow-x-auto border border-[#e8e0d8] rounded-2xl">
            <table class="w-full text-[13.5px]">
                <thead class="bg-[#eedfd0] border-b border-[#232833]">
                    <tr>
                        <th class="text-left px-6 py-3 text-[11px] font-bold uppercase tracking-wider text-[#1a1a1a]">Carrier</th>
                        <th class="text-center px-6 py-3 text-[11px] font-bold uppercase tracking-wider text-[#1a1a1a]">Program</th>
                        <th class="text-center px-6 py-3 text-[11px] font-bold uppercase tracking-wider text-[#1a1a1a]">Max Discount</th>
                        <th class="text-center px-6 py-3 text-[11px] font-bold uppercase tracking-wider text-[#1a1a1a]">UBI Penetration</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-[#1e2330]">
                    ...
                    <tr class="bg-[#f9f7f4] hover:bg-[#f5f0eb] transition-colors">
                        ...
                        <td class="px-6 py-4 text-[#6b6560] text-center">{{ $r[1] }}</td>
...
<section class="bg-[#0e1118]">
    <div class="flex items-center flex-col lg:flex-row-reverse max-w-screen-xl mx-auto">
        <div class="flex-1 py-12 lg:py-16 pl-8">
            <p class="text-[11px] font-black uppercase tracking-[.16em] text-[#c9a96e] mb-5">EV Disruption</p>
            <h2 class="font-bold text-white leading-snug mb-5 familyfont" style="font-size:clamp(24px,2.8vw,34px)">
...
<a href="{{ $r[2] }}" class="block bg-[#151922] p-7 rounded-xl border border-[#232833] hover:border-[#c9a96e] transition-colors">
    <h4 class="font-bold text-[#c9a96e] text-[15px] mb-2.5 familyfont">{{ $r[0] }}</h4>
