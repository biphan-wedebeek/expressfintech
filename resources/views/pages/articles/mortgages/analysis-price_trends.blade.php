...
@section('hero_title','Housing Price Trends: ' . now()->year . ' Market Analysis')
...
@section('hero_date',seoUpdateMonth('mortgages-analysis-trend'))
...
@section('last_updated', seoUpdateMonth('mortgages-analysis-trend'))
...
<div class="hstat"><div class="hstat-v">$420K</div><div class="hstat-l">Median US home price {{ now()->year }}</div></div>
...
<div class="sec">
    ...
    <div class="metrics">
        <div class="mc"><div class="mc-v">$420K</div><div class="mc-l">Median sale price ({{ now()->year }})</div></div>
...
<div class="sec">
    ...
    <ul>
        <li><strong>Lock-in effect</strong> — Homeowners with 2.5–3.5% mortgages from 2020–2021 are reluctant to sell and take on 6.8% loans. This trapped an estimated 30M+ potential sellers in {{ (now()->year -1) . '–' . now()->year }}.</li>
...
<div class="sec">
    ...
    <div class="tbl-wrap">
        <div class="tbl-head"><span>Regional Price Trends — Top US Markets {{ (now()->year -1) . '–' . now()->year }}</span><span class="tbl-badge">{{ now()->year }}</span></div>
        <table>
...
@endsection
@section('related')
<div class="card"><img src="https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?w=600&q=80" alt=""><div class="card-body"><div class="card-tag">Market Analysis</div><h4>Rate Forecasting {{ now()->year }}</h4><p>Fed rate trajectory and its impact on mortgage demand and housing prices.</p></div></div>
